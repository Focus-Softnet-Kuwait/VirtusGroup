...
{
    public class JVOmorfiaController : ApiController
    {
        ...
        [Authorize]
        [HttpPost]
        public IHttpActionResult PostJVOmorfia([FromBody]JVOmorfia jvo)
        {
            ...
            try
            {
                ...
                #region  Commented Code not maintaining sequence of elements.
                ...
                //    if (jvo.Body[i].PaymentType == "Cash")       // CASH TRANSACTION
                //    {
                //    objBody.Add("DrAccount__Id", 230);              // CASH
                //    objBody.Add("CrAccount__Id", 353);              // Sales
                //    }
                //    else if (jvo.Body[i].PaymentType == "KNet")  // K-NET TRANSACTION
                //    {
                //        objBody.Add("DrAccount__Id", 728);          // Knet         Gulf Bank - OML-37144764
                //        objBody.Add("CrAccount__Id", 353);          // Sales        SALES - SERVICE
                //    }
                //    else if (jvo.Body[i].PaymentType == "Insurance")  //INSURANCE TRANSACTION
                //    {
                //        objBody.Add("DrAccount__id", 730);          // Insurance    WAPMED
                //        objBody.Add("CrAccount__Id", 353);          // Sales        SALES - SERVICE
                //    }
                //    else if (jvo.Body[i].PaymentType == "COGS")  // COGS-SERVICES TRANSACTION
                //    {
                //        objBody.Add("DrAccount__id", 365);          // COGS-SERVICES
                //        objBody.Add("CrAccount__Id", 264);          // INVENTORY
                //    }
                //    objBody.Add("Amount", jvo.Body[i].Amount);
                //    objBody.Add("Reference", jvo.Body[i].Reference);
                //    objBody.Add("sRemarks", jvo.Body[i].Remark);
